...
isValid GameState{theBoard = nBoard, whitePlayed = wPlayer@(Played (srcW@(1,0), dstW@(1,1)))||
                  blackPlayed = bPlayer@(Played (srcB@(1,4), dstB(1,3))) } Normal move = if getFromBoard nBoard dstW || dstB == "_" 
                                                                                         then True
                                                                                         else False
